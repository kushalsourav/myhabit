...
const SignUp = () => {
    ...
    return(
        <>
          <Form onHandleSubmit={getUserInputs} type={data.formType} setInput={authState}  postInput={authDispatch} passVisible={!toggle}  setPassVisible={setToggle} error={error} />
        </>
    )
};
